...
import DeliveryPop from "../components/elements/deliverypop";
            ...
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="cart-action text-end">
                  <a className="btn" onClick={handleContinueShoppingClick}>
                ...
                {showDeliveryPop && (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* <button onClick={() => setShowDeliveryPop(false)}>Close</button> */}
                      <DeliveryPop />
                    </div>
                  </div>
                )}
