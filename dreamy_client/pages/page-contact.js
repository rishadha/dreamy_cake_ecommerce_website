                        ...
                        <div className="col-xl-10 col-lg-12 m-auto">
                            <section className="row align-items-end mb-50">
                                <div className="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
                                    ...
                                    <h1 className="mb-35">Let us know how we can help you</h1>
                                    <p className="mb-20">
                                        Dreamy Cake means that we are always ready to assist and provide the best possible solutions to any
                                        queries or concerns regarding cake orders, course registration, or any other related matter.
                                    </p>
                                    <p>
                                        Our dedicated customer service team is committed to ensuring your
                                        satisfaction and making your experience with us a pleasant one.
                                    </p>
                                </div>
                                <div className="col-lg-8">
                                    <div className="row">
                                        <div className="col-lg-6 mb-4">
                                            ...
                                            <p>Follow us on Facebook for the latest updates, promotions, and behind-the-scenes looks at our delicious creations!</p>
                                        </div>
                                        <div className="col-lg-6 mb-4">
                                            <h5 className="mb-20">02. Employer Services</h5>
                                            <p>Dreamy Cake offers various employer services for cake course registrations, event catering, and corporate gifting</p>
                                        </div>
                                        <div className="col-lg-6 mb-lg-0 mb-4">
                                            <h5 className="mb-20 ">03. Billing Inquiries</h5>
                                            <p>Get in touch with us for any billing questions or concerns related to your Dreamy Cake orders</p>
                                        </div>
                                        <div className="col-lg-6">
                                            <h5 className="mb-20">04.General Inquiries</h5>
                                            <p>Get in touch with us for any general questions or concerns about Dreamy Cake</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
